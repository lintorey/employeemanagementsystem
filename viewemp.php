...
<html>
<head>
	<title>View Employee |  Admin Panel | Tapau Food</title>
		...
		<table>
			...
			<?php
				while ($employee = mysqli_fetch_assoc($result)) {
					...
					echo "<td><a href=\"edit.php?id=$employee[id]\"><hi>Edit</a></hi> <a href=\"delete.php?id=$employee[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><hi>Delete</a></hi></td>";
				}
			?>
