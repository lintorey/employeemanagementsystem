...
<body>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homered" href="aloginwel.php">Leaderboard</a></li>
	...
	<div id="divimg">
		...
		<div class="p-t-20">
			<button class="btn btn--radius btn--green" type="submit" style="float: right; margin-right: 60px">
			<a href="reset.php" style="text-decoration: none; color: white"> Reset Points</button>
		</div>
