            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group">
                            <input class="input--style-1" type="file" placeholder="file" name="file" required="required">
                        </div>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="gender">
                                            <option disabled="disabled" selected="selected" required="required">Gender</option>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="Identification Card" name="nid" required="required">
                        </div>
