...
<html>
<head>
	<title>Project Status |  Admin Panel | Tapau Food</title>
...
<body>
	...
	<div class="divider"></div>
		<p style="background-image: url('Fadhlin.jpg');">
		<table>
			<tr>
			...
			<?php
				while ($employee = mysqli_fetch_assoc($result)) {
					...
					echo "<td><a href=\"mark.php?id=$employee[eid]&pid=$employee[pid]\"><hi>Mark</a></hi>"; 
